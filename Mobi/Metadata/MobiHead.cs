...
namespace BiblioUpTik.Mobi.Metadata
{
  public class MobiHead : BaseHeader
  {
    ...
    private byte[] restOfMobiHeader = (byte[]) null;
    private EXTHHead exthHeader = (EXTHHead) null;
    private byte[] remainder = (byte[]) null;
    private byte[] fullName = (byte[]) null;
    ...
    public MobiHead(FileStream fs, uint mobiHeaderSize)
    {
      ...
      this.restOfMobiHeader = new byte[(IntPtr) (uint) ((int) this.HeaderLength + 16 - 132)];
      ...
      int int32 = Converter.ToInt32(this.fullNameLength);
      ...
      bool flag = ((int) Converter.ToUInt32(this.exthFlags) & 64) != 0;
      fs.Read(this.restOfMobiHeader, 0, this.restOfMobiHeader.Length);
      if (flag)
        this.exthHeader = new EXTHHead(fs);
      int num = 132 + this.restOfMobiHeader.Length + this.ExthHeaderSize;
      this.remainder = new byte[(int) ((long) mobiHeaderSize - (long) num)];
      fs.Read(this.remainder, 0, this.remainder.Length);
      int sourceIndex = Converter.ToInt32(this.fullNameOffset) - num;
      this.fullName = new byte[int32];
      if (sourceIndex >= 0 && sourceIndex < this.remainder.Length && (sourceIndex + int32 <= this.remainder.Length && int32 > 0))
        Array.Copy((Array) this.remainder, sourceIndex, (Array) this.fullName, 0, int32);
    ...
    public string FullName
    {
      get
      {
        return Encoding.ASCII.GetString(this.remainder).Replace("\0", string.Empty);
      }
    }
    ...
    public uint MobiType
    {
      get
      {
        return Converter.ToUInt32(this.mobiType);
      }
    }
      ...
      get
      {
        switch (this.MobiType)
        {
          ...
          case 518:
            return "HTML";
          default:
            return string.Format("Unknown (0)", (object) this.MobiType);
        }
      }
    }
    ...
    public uint TextEncoding
    {
      get
      {
        return Converter.ToUInt32(this.textEncoding);
      }
    }
    ...
    public uint UniqueID
    {
      get
      {
        return Converter.ToUInt32(this.uniqueID);
      }
    }
    ...
    public uint FileVersion
    {
      get
      {
        return Converter.ToUInt32(this.fileVersion);
      }
    }
    ...
    public uint OrthographicIndex
    {
      get
      {
        return Converter.ToUInt32(this.orthographicIndex);
      }
    }
    ...
    public uint InflectionIndex
    {
      get
      {
        return Converter.ToUInt32(this.inflectionIndex);
      }
    }
    ...
    public uint IndexNames
    {
      get
      {
        return Converter.ToUInt32(this.indexNames);
      }
    }
    ...
    public uint IndexKeys
    {
      get
      {
        return Converter.ToUInt32(this.indexKeys);
      }
    }
    ...
    public uint ExtraIndex0
    {
      get
      {
        return Converter.ToUInt32(this.extraIndex0);
      }
    }
    ...
    public uint ExtraIndex1
    {
      get
      {
        return Converter.ToUInt32(this.extraIndex1);
      }
    }
    ...
    public uint ExtraIndex2
    {
      get
      {
        return Converter.ToUInt32(this.extraIndex2);
      }
    }
    ...
    public uint ExtraIndex3
    {
      get
      {
        return Converter.ToUInt32(this.extraIndex3);
      }
    }
    ...
    public uint ExtraIndex4
    {
      get
      {
        return Converter.ToUInt32(this.extraIndex4);
      }
    }
    ...
    public uint ExtraIndex5
    {
      get
      {
        return Converter.ToUInt32(this.extraIndex5);
      }
    }
    ...
    public uint FirstNonBookIndex
    {
      get
      {
        return Converter.ToUInt32(this.firstNonBookIndex);
      }
    }
    ...
    public uint FullNameOffset
    {
      get
      {
        return Converter.ToUInt32(this.fullNameOffset);
      }
    }
    ...
    public uint FullNameLength
    {
      get
      {
        return Converter.ToUInt32(this.fullNameLength);
      }
    }
    ...
    public uint MinVersion
    {
      get
      {
        return Converter.ToUInt32(this.minVersion);
      }
    }
    ...
    public uint HuffmanRecordOffset
    {
      get
      {
        return Converter.ToUInt32(this.huffmanRecordOffset);
      }
    }
    ...
    public uint HuffmanRecordCount
    {
      get
      {
        return Converter.ToUInt32(this.huffmanRecordCount);
      }
    }
    ...
    public uint HuffmanTableOffset
    {
      get
      {
        return Converter.ToUInt32(this.huffmanTableOffset);
      }
    }
    ...
    public uint HuffmanTableLength
    {
      get
      {
        return Converter.ToUInt32(this.huffmanTableLength);
      }
    }
