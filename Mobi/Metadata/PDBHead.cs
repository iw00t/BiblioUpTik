...
namespace BiblioUpTik.Mobi.Metadata
{
  public class PDBHead : BaseHeader
  {
    ...
    private List<PDBHead.RecordInfo> recordInfoList = new List<PDBHead.RecordInfo>();
    ...
    public PDBHead(FileStream fs)
    {
      ...
      int int16 = (int) Converter.ToInt16(this.numRecords);
      for (int index = 0; index < int16; ++index)
        this.recordInfoList.Add(new PDBHead.RecordInfo(fs));
    ...
    public string Name
    {
      get
      {
        return Encoding.ASCII.GetString(this.name).Replace("\0", string.Empty);
      }
    }
    ...
    public ushort Attributes
    {
      get
      {
        return Converter.ToUInt16(this.attributes);
      }
    }
    ...
    public ushort Version
    {
      get
      {
        return Converter.ToUInt16(this.version);
      }
    }
    ...
    public uint CreationDate
    {
      get
      {
        return Converter.ToUInt32(this.creationDate);
      }
    }
    ...
    public uint LastBackupDate
    {
      get
      {
        return Converter.ToUInt32(this.lastBackupDate);
      }
    }
    ...
    public uint ModificationNumber
    {
      get
      {
        return Converter.ToUInt32(this.modificationNumber);
      }
    }
    ...
    public uint AppInfoID
    {
      get
      {
        return Converter.ToUInt32(this.appInfoID);
      }
    }
    ...
    public uint SortInfoID
    {
      get
      {
        return Converter.ToUInt32(this.sortInfoID);
      }
    }
    ...
    public uint Type
    {
      get
      {
        return Converter.ToUInt32(this.type);
      }
    }
    ...
    public uint Creator
    {
      get
      {
        return Converter.ToUInt32(this.creator);
      }
    }
    ...
    public uint UniqueIDSeed
    {
      get
      {
        return Converter.ToUInt32(this.uniqueIDSeed);
      }
    }
    ...
    public ushort NumRecords
    {
      get
      {
        return Converter.ToUInt16(this.numRecords);
      }
    }
    ...
    public ushort GapToData
    {
      get
      {
        return Converter.ToUInt16(this.gapToData);
      }
    }
    ...
    public uint MobiHeaderSize
    {
      get
      {
        if (this.recordInfoList.Count > 1)
          return this.recordInfoList[1].RecordDataOffset - this.recordInfoList[0].RecordDataOffset;
        return 0;
      }
    }
    ...
    public class RecordInfo
    {
      ...
      public RecordInfo(FileStream fs)
      {
        ...
        this.recordAttributes = (byte) fs.ReadByte();
      ...
      public uint RecordDataOffset
      {
        get
        {
          return Converter.ToUInt32(this.recordDataOffset);
        }
      }
    }
  }
