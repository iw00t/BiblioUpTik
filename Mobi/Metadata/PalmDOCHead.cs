...
namespace BiblioUpTik.Mobi.Metadata
{
  public class PalmDOCHead : BaseHeader
  {
    ...
    public ushort Compression
    {
      get
      {
        return Converter.ToUInt16(this.compression);
      }
    }
      ...
      get
      {
        switch (this.Compression)
        {
          ...
          case 17480:
            return "HUFF/CDIC";
          default:
            return string.Format("Unknown (0)", (object) this.Compression);
        }
      }
    }
    ...
    public uint TextLength
    {
      get
      {
        return Converter.ToUInt32(this.textLength);
      }
    }
    ...
    public ushort RecordCount
    {
      get
      {
        return Converter.ToUInt16(this.recordCount);
      }
    }
    ...
    public ushort RecordSize
    {
      get
      {
        return Converter.ToUInt16(this.recordSize);
      }
    }
    ...
    public ushort EncryptionType
    {
      get
      {
        return Converter.ToUInt16(this.encryptionType);
      }
    }
      ...
      get
      {
        switch (this.EncryptionType)
        {
          ...
          case 2:
            return "Mobipocket";
          default:
            return string.Format("Unknown (0)", (object) this.EncryptionType);
        }
      }
    }
  }
